...
export default class DeskleafPlugin extends Plugin {
  ...
  async onload() {
    ...
    addIcon("deskleaf", `
      <g transform="scale(4.1667)" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
        <path d="M6.8 13.7c-2.45-2.45-2.25-6.25.25-8.3C8.65 4.1 10.75 3.5 13.35 3.5H18.3c1.2 0 2.2 1 2.2 2.2v4.95c0 2.75-.75 5.05-2.35 6.65-2.2 2.2-5.85 2.25-8.35.1" stroke-width="2"/>
